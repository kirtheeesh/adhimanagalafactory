...
- **`backend/`**: Node.js Express server using TypeScript (`tsx` for execution). Features a structured layout with `routes/`, `middleware/`, and `config/` for MariaDB database interaction.
