...
export default function PackingScanQRScreen() {
  ...
  return (
    <SafeAreaView style={styles.container}>
      <View style={styles.header}>
        <TouchableOpacity onPress={() => router.replace('/packing/packing_list')}>
          <Ionicons name="arrow-back" size={24} color="#fff" />
        </TouchableOpacity>
        <Text style={styles.title}>SCAN QR (PACKING)</Text>
        <View style={{ width: 24 }} />
      </View>
...
const styles = StyleSheet.create({
  ...
  cancelBtn: { flex: 1, padding: 15, borderRadius: 12, borderWidth: 1, borderColor: '#64748B', alignItems: 'center' },
