...
export default function PHeadFooter() {
  ...
  const tabs = [
    { id: '/phead', label: 'Home', icon: 'home' },
    { id: '/phead/inventory', label: 'Inv', icon: 'cube' },
    { id: '/phead/sales_requests', label: 'Sales', icon: 'cart' },
    ...
    { id: '/phead/hourly_reports', label: 'Hourly', icon: 'time' },
    { id: '/phead/attendance', label: 'Att', icon: 'people' },
    { id: '/phead/monitoring', label: 'Mon', icon: 'pulse' },
  ];
