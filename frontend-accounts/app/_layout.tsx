...
export default function RootLayout() {
  useEffect(() => {
    ...
    console.log("RootLayout: Initializing global error handler");

    // Global error handler for React Native
    if (typeof ErrorUtils !== 'undefined') {
        const originalHandler = ErrorUtils.getGlobalHandler();
        ErrorUtils.setGlobalHandler((error, isFatal) => {
          console.log("FATAL ERROR CAUGHT IN BASH LOGS:", error);
      ...
      <GlobalErrorBoundary>
        <MachineProvider>
          <Stack screenOptions={{ headerShown: false }}>
            ...
            <Stack.Screen name="accounts/ledger" />
            <Stack.Screen name="accounts/daybook" />
            <Stack.Screen name="accounts/expenses" />
            <Stack.Screen name="accounts/bank_accounts" />
            <Stack.Screen name="accounts/vendor_payables" />
            <Stack.Screen name="accounts/customer_credits" />
            <Stack.Screen name="accounts/purchase" />
            <Stack.Screen name="accounts/purchase_history" />
            <Stack.Screen name="accounts/purchase_request" />
            <Stack.Screen name="accounts/invoice_list" />
          </Stack>
        </MachineProvider>
      </GlobalErrorBoundary>
    </SafeAreaProvider>
