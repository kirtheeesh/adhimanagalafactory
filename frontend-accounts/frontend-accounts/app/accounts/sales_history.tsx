...
import AccountsFooter from '../../accounts_frontend/AccountsFooter';

export default function AccountsSalesHistoryScreen() {
  ...
  return (
    <SafeAreaView style={styles.container}>
      ...
      <View style={styles.header}>
        <TouchableOpacity onPress={() => router.replace('/accounts/ledger')}>
