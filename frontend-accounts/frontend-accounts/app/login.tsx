    ...
    try {
      ...
      if (response.ok && data.success) {
        ...
        if (userRole !== 'ACCOUNTS') {
          Alert.alert("Access Denied", "This app is for Accounts only.");
          setLoading(false);
          return;
        }
...
const styles = StyleSheet.create({
  ...
  deptBtn: { backgroundColor: 'rgba(255,255,255,0.1)', paddingVertical: 10, paddingHorizontal: 12, borderRadius: 8, borderWidth: 1, borderColor: 'rgba(255,255,255,0.1)', marginRight: 6, marginBottom: 6 },
